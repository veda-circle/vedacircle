...
create-nx-workspace  vedacircle --prefix=ngx --npm-scope=xmlking --package-manager=npm
# or
ng new vedacircle --collection=@nrwl/schematics --prefix=ngx --npm-scope=xmlking --package-manager=npm --verbose
# or if you want *bazel* builds instead of *webpack*
ng new vedacircle --collection=@nrwl/schematics --prefix=ngx --npm-scope=xmlking --package-manager=npm --bazel  --verbose
cd vedacircle
...
npm run workspace-schematic store models/VCDemo -- --project=grid  -d
```
