...
yarn workspace @vedacircle/api add kubernetes-client @xmlking/jwks-rsa @nestjs/{terminus,cqrs}  
yarn workspace @vedacircle/api add addnodemon supertest  -O

yarn workspace @vedacircle/tools add cpx --dev
```
